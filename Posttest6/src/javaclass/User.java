...
public class User extends Account{
    ...
    public void confim_rsv() throws IOException{
        System.out.println("");
    ...
    public void add_menu() throws IOException{
        clearScreen();
        Admin admin = new Admin();
        int choice_roomType = admin.RoomType();
        ...
        if (Admin.room_data.isEmpty()) {
            ...
            double roomPrice = admin.getRoomPrice(choice_roomType);
    ...
    public void Payment_menu() throws IOException {
        clearScreen();
        System.out.println("======================================");
        ...
        try {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    String eWalletAccount = br.readLine();
                    EWallet ewallet = new EWallet();

                    System.out.println();
                    ewallet.setEWalletAccount(eWalletAccount);
                    ewallet.makePayment(); 
                    break;
                case 0:
                    Reservation_menu();
    ...
    public void viewRsv() throws IOException{   
        while (true){
            clearScreen();
            System.out.println("======================================");
            System.out.println("    KING THE LAND HOTEL RESERVATION   ");
            ...
            System.out.println("      2. VIEW RESERVATION BY USERNAME ");
            System.out.println("      0. BACK                         ");
            System.out.println("======================================");
    ...
    //Overloading
    public void read_menu()throws IOException{
        clearScreen();
        System.out.println("=====================================");
    ...
    public  void read_menu(String cust_name) throws IOException{
        if (Reservations.size() == 0){
            System.out.println("No reservation data found, please make reservation to view");
            getche();
        } else {
            ...
            for (int i = 0; i < Reservations.size(); i++) {
                Hotel_Reservation reservation = Reservations.get(i);
                if (reservation.getCustomer_name().equals(cust_name)) {
                    hasReservation = true;
            ...
            if (!hasReservation) {
                System.out.println("No reservation data found for user " + cust_name);
            }
        }
    }

    public  void edit_menu() throws IOException{
        clearScreen();
        System.out.println("=========================================");
    ...
    public  void del_menu() throws IOException{
        clearScreen();
        System.out.println("=========================================");
