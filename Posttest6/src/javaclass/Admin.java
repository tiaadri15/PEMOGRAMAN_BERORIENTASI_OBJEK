...
public class Admin extends Account{
    ...
    private static final double SINGLE_ROOM_PRICE = 750000;
    private static final double TWIN_ROOM_PRICE = 800000;
    private static final double DOUBLE_ROOM_PRICE = 850000;
    private static final double DELUXE_ROOM_PRICE = 900000;
    private static final double SUITE_ROOM_PRICE = 950000;
    private static final double PRESIDENTIAL_ROOM_PRICE = 1000000;
    ...
    public int RoomType() throws IOException {
        System.out.println("==============================================");
    ...
    public double getRoomPrice(int choice_roomType) {
        double price = 0;
        switch (choice_roomType) {
            ...
            case 4:
                ...
                break;
            case 5:
                price = SUITE_ROOM_PRICE;
                break;
            case 6:
                price = PRESIDENTIAL_ROOM_PRICE;
                break;
            default:
                price = 0;
                break;
    ...
    private void AddRoom() throws IOException {
        ...
        String room_type = "";
        double price = getRoomPrice(choice_roomType);
        ...
        if (room_data.isEmpty()) {
            ...
            for (int i = 0; i < room_data.size(); i++) {
                ...
                if (room_attributes.getRoom_type().equals(up_room)) {
                    ...
                    System.out.println("         2. UPDATE ROOM DESCRIPTION          ");
                    ...
                    try {
                        ...
                        switch (choice_update) {
                            ...
                            case 3 -> {
                                ...
                                room_attributes.setStatus(newStatus);
                                System.out.println("");
