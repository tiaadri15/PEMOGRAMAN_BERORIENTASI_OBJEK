                ...
                while (true) {
                    switch(choice_menu){
                        case 1 -> {
                            ...
                            System.out.println("You will be redirected to the login menu. Please wait for 3 seconds!");
                            sleep();
                            loggedIn = true;
                            mainMenu();
                            break;
                        ...
                        case 2 -> {
                            ...
                            if (Username.equalsIgnoreCase(adminAccount.getUsername()) && Password.equalsIgnoreCase(adminAccount.getPassword())) {
                                ...
                                System.out.println("You will be redirected to the admin menu. Please wait for 3 seconds!");
                                loggedIn = true;
                                sleep();
                                ...
                                System.out.println("You will be redirected to the receptionist menu. Please wait for 3 seconds!");
                                loggedIn = true;
                                sleep();
                                ...
                                for (int i = 0; i < UserAccount.size(); i++) {
                                    ...
                                    if (Username.equalsIgnoreCase(user.getUsername()) && Password.equals(user.getPassword())) {
                                        ...
                                        System.out.println("You will be redirected to the user menu. Please wait for 3 seconds!");
                                        currentUser = user;
                                        loggedIn = true;
                                        sleep();
                                        User.menu();
